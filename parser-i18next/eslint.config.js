...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      // i18next is the only runtime dependency; any other bare import
  ...
  {
    // The file-wide disable directive of the shared tsup config stays;
    // without this opt-out, `--fix` would strip it as unused.
