...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      // intl-messageformat is the only runtime dependency; any other bare
  ...
  {
    // The public types (Parser.T, Parser.Params, Config) are namespace-shaped
    // since v1, spelled with the `module` keyword of that era.
    files: ['src/types.ts'],
    rules: {
