...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      // messageformat is the only runtime dependency; any other bare import
      // reachable from src/ is a bug.
  ...
  {
    // The file-wide disable directive of the shared tsup config stays; without
    // this opt-out, `--fix` would strip it as unused.
